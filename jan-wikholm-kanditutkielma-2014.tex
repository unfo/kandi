...
\classification{C.2.2 [Network Protocols]}
%\classification{K.6.5 [Security and Protection]}
...
\noindent\\
Todentajalaitteen, \emph{C}, rooli on toimia todistajana A:lle B:n suhteen -- ja päinvastoin -- että B kuuluu C:lle ja että se kuuluu eli sektorilta kuin A kuulee B:n. Katso kuva~\ref{fig:todentaja1}.
