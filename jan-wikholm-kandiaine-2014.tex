...
Madonreikähyökkäys on erityisen voimakas hyökkäys langattomissa ad hoc -verkoissa.~\cite{leashes} .
...
\subsection{Radiotaajuuksien vesileimat}
\subsection{Suunta-antenni}

\newpage
\section{Protokollapohjaiset puolustusmekanismit}
\subsection{Naapuruslistat}
\subsection{DeWorm}
\subsection{LiteWorp}
\subsection{MobiWorp}
